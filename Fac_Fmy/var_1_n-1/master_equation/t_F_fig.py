...
data1 = np.loadtxt('t_F_N100_Ae4_x0001e6_tmax10000.dat')
...
axe.plot(l1, p1, 'o-', c='black', label = r'$edge$')#'$k_{on}^{c}=2,k_{off}=0.2$')
axe.plot(l2, p2, 's-', c='red', label = r'$center$')#'$k_{on}^{c}=5,k_{off}=0.2$')
axe.plot(l3, p3, 'v-', c='blue', label = r'$average$')#'$k_{on}^{c}=10,k_{off}=0.2$')
...
axe.legend(loc='best')
fig.savefig("fig_3patarn_t_F_x0_N100_Ae4_tmax10000.png")
#plt.show()
