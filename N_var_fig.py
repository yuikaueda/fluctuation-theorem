...
data1 = np.loadtxt('ver_N100_x001e6_tmax100.dat')
data2 = np.loadtxt('ver_N150_x001e6_tmax100.dat')
data3 = np.loadtxt('ver_N200_x001e6_tmax100.dat')
...
axe.plot(l1, p1, 'o-', c='black', label = r'$N_{s}=100$')#'$k_{on}^{c}=2,k_{off}=0.2$')
axe.plot(l2, p2, 's-', c='red', label = r'$N_{s}=150$')#'$k_{on}^{c}=5,k_{off}=0.2$')
axe.plot(l3, p3, 'v-', c='blue', label = r'$N_{s}=200$')#'$k_{on}^{c}=10,k_{off}=0.2$')
...
axe.legend(loc='best')
fig.savefig("fig_var_N_x001e6_tmax100.png")
#plt.show()
